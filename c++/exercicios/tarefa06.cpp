...
void exibir ( double a, double b, double c, double delta )
{
    cout << "\nValor de ....A:" << setprecision(5) << setw(2) << a;
    cout << "\nValor de ....B:" << setprecision(5) << setw(2) << b;
    cout << "\nValor de ....C:" << setprecision(5) << setw(2) << c;
    cout << "\nValor de Delta:" << setprecision(5) << setw(2) << delta;
    system("sleep 2");
...
{ 
    ...
    cout << "\nValor de ....x1:" << setprecision(5) << setw(2) << x1;
    cout << "\nValor de ....x2:" << setprecision(5) << setw(2) << x2 << endl;
}
else 
{ 
